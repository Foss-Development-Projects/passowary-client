...
const Navbar = () => {
    return (
        <nav className="backdrop-blur-sm bg-blue-500/[.09] sticky top-0 mt-1 mx-1.5 px-2 rounded-md z-10">
            <ul className="navbar-list h-16 flex overflow-x-scroll py-1" style={navbarListStyles}>
                ...
                {
                    !authenticated && <Navlink name="Login" href="/login" icon={<FaDoorOpen />} />
                }
                <Navlink name="Register" href="/register" icon={<RiUserAddFill />} />
                <Navlink name="About" href="/about" icon={<FaInfoCircle />} />
            </ul>
        </nav>
    )
}
