            ...
            <form action="" name="account-delete-form" className="p-2 rounded-md" method="POST">
                <section className="bg-zinc-950/[.09] p-2 rounded-md my-3">
                    <section className="flex items-center justify-between">
                        <p className="text-md">Suspend Your Acccount For A Period of Time</p>
                ...
                <section className="bg-zinc-950/[.09] p-2 rounded-md my-3">
                    <section className="flex items-center justify-between">
                        <p className="text-md">Delete Your Acccount Permanently</p>
                        <button type="submit" title="Delete Account Permanently" className="bg-red-600 
                    hover:bg-red-700 ml-3 p-2 rounded-full text-gray-200"><GrHalt size={iconSize} /></button>
                    </section>
                    <section className="my-2">
